        ...
        <div>
            ...
            <div className='flex justify-center p-4 bg-test min-h-screen min-w-fit'>
                <div className='relative felx flex-row md:items-center sm:justify-center bg-background shadow-2xl rounded-2xl md:flex md:flex-col md:space-y-0 md:m-0 md:mx-auto md:w-3/4 sm:min-w-fit'>
                    <figure className='pt-4 sm:w-24 md:w-40'><Image src={ProfileVendorMock} alt="Vendor's Profile" width={200}/></figure>
                    <div>
                    ...
                    <div className='flex md:flex-row space-x-2 p-4'>
                        <P text="Language:" style='font-light md:text-sm sm:text-xs p-2'></P>
                        <P text="English" style='font-light bg-secondary text-white rounded-xl md:text-sm sm:text-xs p-2'></P>
                        <P text="Japanese" style='font-light bg-secondary text-white rounded-xl md:text-sm sm:text-xs p-2'></P>

                    </div>
                    <div className='flex md:flex-row space-x-2 p-4'>
                        <P text="Shopping Rate:" style='font-light md:text-sm sm:text-xs p-2'></P>
                        <P text="300 Baht" style='font-light bg-secondary text-white rounded-xl md:text-sm sm:text-xs p-2'></P>
                    </div>
                    <div className='flex md:flex-row space-x-2 p-4'>
                        <P text="Currency Rate:" style='font-light md:text-sm sm:text-xs p-2'></P>
                        <P text="1 US Dollar = 35 Baht" style='font-light bg-secondary text-white rounded-xl md:text-sm sm:text-xs p-2'></P>
                        <P text="1 Yen = 0.3 Baht" style='font-light bg-secondary text-white rounded-xl md:text-sm sm:text-xs p-2'></P>
