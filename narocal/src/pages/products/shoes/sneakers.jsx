...
export default function Sneakers(){
    ...
    let thisPageUpper = "Sneakers"
    let thisPageLower = "sneakers"

    function findFilterHandler(brand, category, sortPrice){
        const fullPath = `/products/shoes/${thisPageLower}/${brand}/${category}/${sortPrice}`;
            ...
            <div className='flex flex-col justify-center bg-test pt-40 w-screen'>
                <div className='flex flex-col gap-y-10 bg-background p-20 w-full mb-8 min-h-screen'>
                    ...
                    <div className="text-md breadcrumbs">
                        <ul>
                            <li><a href='/'>Home</a></li> 
                            <li><a href='/shoes/shoes'>Shoes</a></li> 
                            <li>{thisPageUpper}</li>
                        </ul>
                    </div>
