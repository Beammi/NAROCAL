...
export default function Conveniencefood(){
    ...
    let thisPageUpper = "Convenience food"
    let thisPageLower = "conveniencefood"

    function findFilterHandler(brand, category, sortPrice){
        const fullPath = `/products/food/${thisPageLower}/${brand}/${category}/${sortPrice}`;
